    ...
    <div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='about-service col-12 col-md-6'>
              ...
              <a href='#' className='read-more-btn' style={{paddingTop: '6px'}}>
                Read More{' '}
              </a>
            </div>
      ...
      <section id='features'>
        <div className='container'>
          ...
          <a className='read-more-btn' href='#' style={{paddingTop: '6px'}}>
            read more
          </a>
        </div>
      </section>
      ...
      >
        <Box sx={{ ...style, width: '60%' }}>
          ...
          {/m* <Button id='btnMui123' onClick={handleClose}>Close Child Modal</Button> *m/}
        </Box>
      </Modal> */}
    </div>
  );
