...
const GpsVendor = () => {
  ...
  function handleClickView(rowData) {
    setMyId(rowData?.id || rowData?._id);
  }
    ...
    <>
      ...
      {myId == 'create' ? (
        ...
        >
          ...
          >
            <h1 style={{paddingRight:'5rem'}}>Add Vendor Name</h1>
            <div style={{position: 'absolute', right: '12px', top: '22px'}}>
              <CloseIcon
                sx={{cursor: 'pointer' }}
                onClick={() => {
                  setMyId('');
      ...
      {myId && myId != 'create' ? (
        ...
        >
          <DialogTitle style={{background: '#f4f2f2'}}>
            <h1 style={{paddingRight:'5rem'}}>Update Vendor Name</h1>
            <CloseIcon
              style={{
                position: 'absolute',
                top: '22px',
      ...
      <Confirm
        ...
        cnfMsg={'Are you sure, You want to deactivate the gps?'}
      ...
      <Confirm
        ...
        cnfMsg={'Are you sure, You want to reactivate the gps?'}
