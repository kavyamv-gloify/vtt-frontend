...
const fieldList = [
  ...
  {title: 'Pollution Standard', value: 'standardSelect'},
  {title: 'Fuel Type', value: 'fuelType'},
  {title: 'Model Type', value: 'modelName'},
...
const List = () => {
  ...
  function handleClickGps(rowData) {
    ...
    setCorporateName(user.userList.corporateId);
    ...
    <>
      <Grid container spacing={2} sx={{mb: 6}} className='page-header-second'>
        <Grid item xs={12} sm={3} md={4} sx={{mb: 2}}>
          <CustomLabel labelVal='Vehicles' variantVal='h3-underline' />
        </Grid>
          ...
          <Box display='flex' justifyContent='flex-end' alignItems='center'>
            ...
            {myActions?.includes('Download And Upload') && (
              <ExcelContainer
                ...
                downloadURL={'/user-reg/vehicle-reg/download'}
                getHeadersUrl={'/user-reg/vehicle-reg/headerdata'}
                downloadTempURL={'/user-reg/vehicle-reg/download-template'}
                uploadURL={'/user-reg/vehicle-reg/import-excel'}
              />
            )}
          </Box>
        </Grid>
                          ...
                          <div style={{padding: '20px', paddingTop: '0'}}>
                            {(vehicleGpsId?.securityKey || backendGpsKey) && (
                              ...
                              >
                                ...
                                {vehicleGpsId?.securityKey && (
                                  <div>
                                    {openGpsUpdateDialog === 'open' ? null : (
                                      <Button
                                        variant='contained'
                                        onClick={() => {
                                          setOpenGpsDialog(false);
                                          setOpenGpsUpdateDialog('open');
                                        }}
                                      >
                                        Update
                                      </Button>
      ...
      >
        <>
          ...
          {console.log('backendGpsKey', backendGpsKey)}
          {vehicleGpsId?.securityKey || backendGpsKey?.imeiNO ? (
