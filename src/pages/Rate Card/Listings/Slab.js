...
console.log("fuelType fuelTypeVal fuelTypeVal", fuelTypeVal)
  ...
  function vendorList() {
    axios
      .get(
        Api.baseUri +
          '/user-reg/tripRateCard/byFilter/SLAB/' +
          vendorId +
          '/' +
          fuelTypeVal?.value,
      )
  ...
  console.log("Prince",datas)
  return (
    <div>
      <div style={{background: 'white', marginTop: '25px', padding: '20px'}}>
        {datas?.length === 0 ? <h3 style={{textAlign: "center"}}>No Data Found</h3> : 
        datas?.map((el, _i) => {
          return (
            <Accordion
                                ...
                                <TableFooter>
                                  <TableRow>
                                    <TablePagination
                                      ...
                                      colSpan={8}
                                      count={vendortable[el].length} //rows.length
