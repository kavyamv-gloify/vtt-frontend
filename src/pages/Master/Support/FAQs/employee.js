  ...
  return (
    <>
      ...
      <SmartTable
        ...
        data={(query) =>
          new Promise((resolve, reject, values) => {
            let url = `${api.support.getAllFAQs}?page=${query.page}&size=${query.pageSize}&subTopicName=null&question=null&answer=null&type=EMPLOYEE`,
              body = {
      ...
      <Confirm
        ...
        cnfMsg={'Are you sure, You want to reactivate the FAQ?'}
