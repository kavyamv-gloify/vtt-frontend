...
const List = () => {
  ...
  function handleClickView(rowData) {
    navigate('/Master/bank/detailpage/' + rowData.id);
  }
  function handleClickEdit(rowData) {
    navigate('/Master/bank/editpage/' + rowData.id);
  }
    ...
    <>
      ...
      {userStatus == 'Active' ? (
          ...
          <SmartTable
            ...
            data={(query) =>
              new Promise((resolve, reject, values) => {
                let url = api.masterBank.list + `/Active`,
                  body = {
        ...
        <SmartTable
          ...
          data={(query) =>
            new Promise((resolve, reject, values) => {
              let url = api.masterBank.list + `/Inactive`,
                body = {
                  pageSize: query.pageSize,
                  pageNo: query.page,
                };
